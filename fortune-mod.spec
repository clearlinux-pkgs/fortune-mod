...
Source0  : https://www.shlomifish.org/open-source/projects/fortune-mod/arcs/fortune-mod-3.24.0.tar.xz
...
%prep
%setup -q -n fortune-mod-3.24.0
cd %{_builddir}/fortune-mod-3.24.0
pushd ..
cp -a fortune-mod-3.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735071957
mkdir -p clr-build
pushd clr-build
...
/usr/share/games/fortunes/the-x-files-taglines
/usr/share/games/fortunes/the-x-files-taglines.dat
/usr/share/games/fortunes/the-x-files-taglines.u8
