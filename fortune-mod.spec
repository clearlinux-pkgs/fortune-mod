...
Source0  : https://www.shlomifish.org/open-source/projects/fortune-mod/arcs/fortune-mod-3.16.0.tar.xz
...
%prep
%setup -q -n fortune-mod-3.16.0
cd %{_builddir}/fortune-mod-3.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677079461
mkdir -p clr-build
pushd clr-build
