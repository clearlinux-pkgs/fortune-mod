...
Source0  : https://www.shlomifish.org/open-source/projects/fortune-mod/arcs/fortune-mod-3.22.0.tar.xz
...
%prep
%setup -q -n fortune-mod-3.22.0
cd %{_builddir}/fortune-mod-3.22.0
pushd ..
cp -a fortune-mod-3.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719963326
mkdir -p clr-build
pushd clr-build
