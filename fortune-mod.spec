...
Version  : 3.4.0
Release  : 9
URL      : https://www.shlomifish.org/open-source/projects/fortune-mod/arcs/fortune-mod-3.4.0.tar.xz
Source0  : https://www.shlomifish.org/open-source/projects/fortune-mod/arcs/fortune-mod-3.4.0.tar.xz
...
%prep
%setup -q -n fortune-mod-3.4.0
cd %{_builddir}/fortune-mod-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604937033
mkdir -p clr-build
pushd clr-build
